...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      ...
      data-size={size}
      className={cn(
        // Radix exposes checked state as data-state="checked|unchecked" — the
        // bare data-checked/data-unchecked variants (Base UI convention) never
        // match, which left the track transparent and the switch invisible.
